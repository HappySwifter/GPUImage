...
- (void)recalculateViewGeometry;
{
    runSynchronouslyOnVideoProcessingQueue(^{
        ...
        CGSize currentViewSize = self->boundsSizeAtFrameBufferEpoch;
        
        //    CGFloat imageAspectRatio = inputImageSize.width / inputImageSize.height;
        //    CGFloat viewAspectRatio = currentViewSize.width / currentViewSize.height;
        
        if (self->inputImageSize.width == 0 || self->inputImageSize.height == 0) {
            self->inputImageSize = self->boundsSizeAtFrameBufferEpoch;
        }
        CGRect insetRect = AVMakeRectWithAspectRatioInsideRect(self->inputImageSize, CGRectMake(0, 0, self->boundsSizeAtFrameBufferEpoch.width, self->boundsSizeAtFrameBufferEpoch.height));
